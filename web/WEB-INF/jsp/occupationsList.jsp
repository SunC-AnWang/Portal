...
<html> 
	...
	<body>
				...
				<div class="authority">
					<div class="authority-head">
						<div class="manage-head">
							<h6 class="layout padding-left manage-head-con">职位管理
						...
						<div class="list-content show">
							<div class="offcial-table tr-border margin-big-top clearfix">
								<div class="tr-th clearfix">
									...
									<div class="th w15">
										操作
                                                            ...
                                                            <c:forEach items="${occupationsList}" var="o">
								...
								<div class="tr clearfix border-bottom-none">
									...
									<div class="td w15">
                                                                                 <a href="occupations/toAddOccupations" class="button-word2 btn_ajax_confirm">添加</a>
                                                                                 <a href="occupations/toEditOccupations?oid=${o.oid}" class="button-word2 btn_ajax_confirm">编辑</a>
										 <a href="javascript:deleteOccupations(${o.oid})" class="button-word2 btn_ajax_confirm">删除</a>
									</div>
								</div>
           ...
           <script>
            function deleteOccupations(oid) {
                $.ajax({
                    url:'occupations/deleteOccupations',
                    type: "POST",
                    data: {"oid": oid}, //发送编号给服务器删除员工信息
                    success: function () {
                        //服务器删除员工的同时从表格删除当前行
                        //需要在打印tr的时候给每个tr一个id用于区分没一行
                       
                        $("#" + oid).remove(); //remove删除当前元素和其内容
                         alert("删除成功！");
                    },
                    error: function () {
                        alert("Ajax请求失败!");
