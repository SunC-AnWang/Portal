								...
								<div class="tr-th clearfix">
									...
									<div class="th w15">
										操作
                                                            ...
                                                            <form action="areas/editAreas">
                                                            
                                                            
								<div class="tr clearfix border-bottom-none">
									<div class="td w20">
									<input type="text" name="rid" value="${r.rid}">	
									</div>
									<div class="td w20">
									...
									<div class="td w15">
										<input type="text" name="district" value="${r.district}">
									</div>
									<div class="td w15">
										<input type="text" name="postCode" value="${r.postCode}"> 
									</div>
									<div class="td w15">
