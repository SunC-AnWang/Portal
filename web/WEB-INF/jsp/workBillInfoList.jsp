				...
				<div class="authority">
					<div class="authority-head">
						<div class="manage-head">
							<h6 class="layout padding-left manage-head-con">工单管理
						...
						<div class="list-content show">
							<div class="offcial-table tr-border margin-big-top clearfix">
								<div class="tr-th clearfix">
									...
									<div class="th w15">
										删除
                                                            ...
                                                            <c:forEach items="${workBillInfoList}" var="w">
								...
								<div class="tr clearfix border-bottom-none">
									...
									<div class="td w15">
										<a href="workBillInfo/addWorkBillInfo" class="button-word2 btn_ajax_confirm">添加</a>
									</div>
									<div class="td w15">
										 <a href="workBillInfo/toEditWorkBillInfo?did=${w.wid}" class="button-word2 btn_ajax_confirm">编辑</a>
									</div>
									<div class="td w15">
