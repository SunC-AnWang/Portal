				...
				<div class="authority">
					<div class="authority-head">
						<div class="manage-head">
							<h6 class="layout padding-left manage-head-con">编辑职位信息
						...
						<div class="list-content show">
							<div class="offcial-table tr-border margin-big-top clearfix">
								<div class="tr-th clearfix">
									...
									<div class="th w15">
										操作
                                                            ...
                                                            <form action="occupations/editOccupations">
								...
								<div class="tr clearfix border-bottom-none">
									...
									<div class="td w20">
									<input type="text" name="eoccupation" value="${o.eoccupation}">	
									</div>
									<div class="td w15">
										<input type="text" name="other" value="${o.other}">
									</div>
									<div class="td w15">
