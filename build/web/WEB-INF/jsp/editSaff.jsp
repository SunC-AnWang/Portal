								...
								<div class="tr-th clearfix">
									...
									<div class="th w15">
										操作
                                                            ...
                                                            <form action="saff/editSaff">
                                                            
                                                            
								<div class="tr clearfix border-bottom-none">
									<div class="td w20">
									<input type="text" name="sid" value="${s.sid}">	
									</div>
									<div class="td w20">
									<input type="text" name="sname" value="${s.sname}">	
									</div>
									<div class="td w15">
										<input type="text" name="sgender" value="${s.sgender}">
									</div>
									<div class="td w15">
										<input type="text" name="sphone" value="${s.sphone}">
									</div>
									<div class="td w15">
										 <input type="text" name="semail" value="${s.semail}">
									</div>
									<div class="td w15">
