...
public class LoginController {
    ...
    public String login(int eid,String epwd,String remember ,Model model ,HttpServletRequest request,HttpSession session,HttpServletResponse resp){
    ...
    if(incode != null && rightcode != null){  
         ...
         EmployeesInfo em=employeesInfoService.validateEmployeesInfo(eid,epwd);
